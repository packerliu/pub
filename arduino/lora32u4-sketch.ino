...
/* VL
 *  date: 2019-06-12
 *  source: https://raw.githubusercontent.com/kersing/node-workshop/master/lora32u4-sketch/lora32u4-sketch.ino 
 */
...
//VL: static const u1_t DEVEUI[8]  = { 0x76, 0xA0, 0xA6, 0x01, 0xAC, 0xC2, 0x8B, 0x00 };
static const u1_t DEVEUI[8]  = { 0xB4, 0x4D, 0x72, 0xFB, 0x4C, 0x9B, 0x4F, 0x00 };

//VL: static const u1_t APPEUI[8] = { 0xBD, 0x7C, 0x00, 0xD0, 0x7E, 0xD5, 0xB3, 0x70 };
static const u1_t APPEUI[8] = { 0x5C, 0xDB, 0x01, 0xD0, 0x7E, 0xD5, 0xB3, 0x70 };

// This key should be in big endian format (or, since it is not really a
// number but a block of memory, endianness does not really apply). In
// practice, a key taken from ttnctl can be copied as-is.
// The key shown here is the semtech default key.
//VL: static const u1_t APPKEY[16] = { 0xAE, 0x6A, 0xFA, 0xA3, 0x30, 0x9C, 0xEF, 0xE4, 0xAE, 0x69, 0x2F, 0x63, 0xC3, 0x34, 0x96, 0xF6 };
static const u1_t APPKEY[16] = { 0xF6, 0x35, 0x6B, 0x4E, 0xD0, 0xE0, 0xE1, 0x4A, 0x83, 0x20, 0x8D, 0xD8, 0x24, 0x85, 0x84, 0xF0 };
...
void setup()
  ...
  delay(5000);
  Serial.begin(9600);
  Serial.println(F("Starting, waiting for 5 sec to init..."));
  delay(5000);
  os_init();
